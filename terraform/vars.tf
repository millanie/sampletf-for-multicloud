...
variable "az_list" { description = "list of availability zones " default = [] }
...
variable "pub_subnet_cidr_list" { description = "list of subnet cidrs" default = [] }
variable "prv_subnet_cidr_list" { description = "list of subnet cidrs" default = [] }

## EC2
variable "ec2_type" { description = "instance type" }
variable "keyfile" { description = "keypair name for ec2 which you prepares" }
variable "ec2_sg_list" { description = "security group list for ec2" default = [] }
